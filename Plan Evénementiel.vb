...
Public Class Plan_Evénementiel
    ...
    Private Sub Plan_Evénementiel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        tb_ID_PLANING.Text = ""
        tb_NCIN_responsable.Text = ""
        tb_nom_planing.Text = ""
        cb_evenement.Text = ""
        ...
        cmd1.CommandText = "select * from planing where nom_planing='evenementiel' "
    ...
    Private Sub bt_chercher_Click(sender As Object, e As EventArgs) Handles bt_chercher.Click
        ...
        If verif() Then
            ...
            If dr1.Read() Then
                ...
                If tb_nom_planing.Text = "evenementiel" Then
                    bt_Ajouter.Enabled = False
    ...
    Private Sub bt_modifier_Click(sender As Object, e As EventArgs) Handles bt_modifier.Click
        tb_nom_planing.Text = "evenementiel"
                ...
                If MsgBox("Etes vous sûr de vouloir ajouter?", vbYesNo, "Ajouter") = MsgBoxResult.Yes Then
                    ...
                    Else
                        ...
                        If verif2() Then
                            ...
                            cmd18.CommandText = "select * from planing where nom_planing='evenementiel' "
