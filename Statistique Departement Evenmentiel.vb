...
Public Class Statistique_Departement_Evenmentiel
    Private Sub Statistique_Departement_Evenmentiel_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.Connection = con
        cmd.CommandText = "select MEMBRE.NOM_MEMBRE,MEMBRE.PRENOM_MEMBRE,tache_note from MEMBRE,PARTICIPE_MEMBRE where MEMBRE.NCIN_MEMBRE=PARTICIPE_MEMBRE.NCIN_MEMBRE and MEMBRE.ID_DEPARTEMENT='d1'"
        ...
        ' Texte  du titre
        Chart1.Titles(0).Text = "Graphique affichant la productivité de chaque membre de departement evenmentiel"
